...
class StackTests(unittest.TestCase):
    ...
    def test_push(self):
        ...
        self.assertTrue(
            len(s) == 1,
            f"length of empty stack after pushing 1 element should be 1, but was {len(s)}",
        )
    ...
    def test_pop(self):
        ...
        self.assertTrue(
            len(s) == 0,
            f"length of stack with 1 element after popping 1 element should be 0, but was {len(s)}",
        )
